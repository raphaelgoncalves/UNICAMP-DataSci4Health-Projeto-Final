...
----- | ----- | -----
SIH - DATASUS | http://www2.datasus.gov.br/DATASUS/index.php?area=02 | A finalidade inicial do Sistema de Informações Hospitalares - SIH foi a de controle administrativo-financeiro para pagamento aos serviços hospitalares contratados pelo Instituto Nacional de Assistência Médica e Previdência Social (INAMPS)
